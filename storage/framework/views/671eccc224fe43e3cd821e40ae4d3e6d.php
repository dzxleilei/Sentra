...
<?php $__env->startSection('content'); ?>
    <article class="mb-4 rounded-2xl border border-slate-200 bg-slate-50 p-4">
        ...
        <p class="mt-2 text-xs text-slate-600">Nama: <?php echo e(Auth::user()->name); ?></p>
        <p class="mt-1 text-xs text-slate-600">Email: <?php echo e(Auth::user()->email); ?></p>
        <p class="mt-1 text-xs text-slate-600">Poin Penalti: <?php echo e((int) Auth::user()->penalty_points); ?></p>

        <form id="logout-form" action="<?php echo e(route('logout')); ?>" method="POST" class="mt-4">
            <?php echo csrf_field(); ?>
    ...
    <article class="rounded-2xl border border-slate-200 p-4">
        ...
        <form id="change-password-form" action="<?php echo e(route('update-password')); ?>" method="POST" class="mt-4 space-y-3">
            <?php echo csrf_field(); ?>
            <div>
...
<?php echo $__env->make('layouts.peminjam', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Projects\Sentra\resources\views/peminjam/pengaturan.blade.php ENDPATH**/ ?>