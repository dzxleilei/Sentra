        ...
        <div class="overflow-x-auto">
            <table class="w-full min-w-[1200px]">
                <thead class="bg-slate-50">
                    <tr>
                        <th class="px-6 py-3.5 text-left text-xs font-semibold uppercase tracking-wide text-slate-600">Kode Tiket</th>
                        <th class="px-6 py-3.5 text-left text-xs font-semibold uppercase tracking-wide text-slate-600">Jenis</th>
                        ...
                        <th class="px-6 py-3.5 text-left text-xs font-semibold uppercase tracking-wide text-slate-600">Detail Barang / Bukti</th>
                    </tr>
                </thead>
                <tbody class="divide-y divide-slate-200">
                    <?php $__empty_1 = true; $__currentLoopData = $groupedTickets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kodeBooking => $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <tr class="align-top hover:bg-slate-50">
                            <td class="px-6 py-3.5 font-mono text-sm text-slate-700"><?php echo e($kodeBooking); ?></td>
                            <td class="px-6 py-3.5 text-sm text-slate-700"><?php echo e($first->tipe); ?></td>
                                                ...
                                                <tr class="border-b border-slate-100 align-top">
                                                    ...
                                                    <td class="px-4 py-3">
                                                        <?php if($item->foto_awal): ?>
                                                            <a href="<?php echo e(route('admin.laporan.tiket.foto', ['id' => $item->id, 'jenis' => 'awal'])); ?>" target="_blank" class="font-semibold text-blue-700 hover:text-blue-900">Lihat</a>
                                                        <?php else: ?>
                                                            -
                                                        <?php endif; ?>
                                                    </td>
                                                    <td class="px-4 py-3">
                                                        <?php if($item->foto_akhir): ?>
                                                            <a href="<?php echo e(route('admin.laporan.tiket.foto', ['id' => $item->id, 'jenis' => 'akhir'])); ?>" target="_blank" class="font-semibold text-blue-700 hover:text-blue-900">Lihat</a>
                                                        <?php else: ?>
                                                            -
                                                        <?php endif; ?>
                                                    </td>
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <tr>
                            <td colspan="5" class="px-6 py-8 text-center text-sm text-slate-500">Belum ada tiket untuk periode ini.</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
