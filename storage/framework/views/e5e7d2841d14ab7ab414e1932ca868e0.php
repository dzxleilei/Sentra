...
<body class="bg-gray-50">
    <div class="flex h-screen overflow-hidden bg-slate-50 text-slate-900">
        ...
        <aside class="h-screen w-72 overflow-y-auto border-r border-slate-200 bg-white p-6">
            ...
            <nav class="space-y-2">
                <a href="<?php echo e(route('admin.dashboard')); ?>" class="block rounded-xl px-4 py-3 text-sm font-semibold transition <?php echo e(request()->routeIs('admin.dashboard') ? 'bg-blue-600 text-white' : 'text-slate-700 hover:bg-slate-100'); ?>">
                ...
                <a href="<?php echo e(route('admin.user.peminjam')); ?>" class="block rounded-xl px-4 py-3 text-sm font-semibold transition <?php echo e(request()->routeIs('admin.user.peminjam') ? 'bg-blue-600 text-white' : 'text-slate-700 hover:bg-slate-100'); ?>">
                ...
                <a href="<?php echo e(route('admin.laporan.rusak')); ?>" class="block rounded-xl px-4 py-3 text-sm font-semibold transition <?php echo e(request()->routeIs('admin.laporan.rusak') ? 'bg-blue-600 text-white' : 'text-slate-700 hover:bg-slate-100'); ?>">
            ...
            <div class="mt-8 border-t border-slate-200 pt-8">
                <div class="space-y-2 mb-4">
                    <a href="<?php echo e(route('setting')); ?>" class="block rounded-xl px-4 py-3 text-sm font-semibold transition <?php echo e(request()->routeIs('setting') || request()->routeIs('change-password') ? 'bg-blue-600 text-white' : 'text-slate-700 hover:bg-slate-100'); ?>">
                        <i class="fas fa-gear mr-2"></i> Setting
                    </a>
                    <a href="<?php echo e(route('admin.faq')); ?>" class="block rounded-xl px-4 py-3 text-sm font-semibold transition <?php echo e(request()->routeIs('admin.faq') ? 'bg-blue-600 text-white' : 'text-slate-700 hover:bg-slate-100'); ?>">
        ...
        <main class="h-screen flex-1 overflow-y-auto p-8">
            <div class="max-w-7xl mx-auto">
                <!-- Header -->
                <div class="mb-8">
                    <h2 class="text-2xl font-bold text-slate-900"><?php echo $__env->yieldContent('page_title', 'Dashboard Admin'); ?></h2>
                    <p class="mt-1 text-sm text-slate-600"><?php echo $__env->yieldContent('page_subtitle', 'Kelola seluruh sistem booking sarana dan prasarana'); ?></p>
                </div>
