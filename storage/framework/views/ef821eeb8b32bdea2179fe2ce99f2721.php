    ...
    <div class="login-container" x-data="loginForm()">
        ...
        <div class="w-full lg:w-1/2 flex flex-col justify-center items-center min-h-screen lg:min-h-auto px-4 py-8 sm:py-12 lg:py-0">
            <div class="w-full max-w-sm">
                ...
                <!-- Login Form -->
                <form action="<?php echo e(route('login')); ?>" method="POST" @submit.prevent="handleSubmit" class="space-y-4">
                    <?php echo csrf_field(); ?>
...
</html><?php /**PATH D:\Projects\Sentra\resources\views/auth/login.blade.php ENDPATH**/ ?>